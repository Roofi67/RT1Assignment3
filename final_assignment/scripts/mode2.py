...
if __name__=="__main__":
    ...
    while(1):
        ...
        if boolprint == 1:
            ...
            print("mode 2 is currently in idle state.\n")
            boolprint = 0

        # If the mode 2 is active, we want to procede with the task.
        ...
        while(rospy.get_param("/active") == 2):
            ...
            if boolprint == 0:
                print("You can start using this mode!\n")
                boolprint = 1
